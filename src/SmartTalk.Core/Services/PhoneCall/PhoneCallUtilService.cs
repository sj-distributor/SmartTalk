...
public class PhoneCallUtilService : IPhoneCallUtilService
{
    ...
    public PhoneCallUtilService(IVectorDb vectorDb, ISmartiesClient smartiesClient, 
        IPhoneCallDataProvider phoneCallDataProvider, IRestaurantDataProvider restaurantDataProvider)
    {
        _vectorDb = vectorDb;
     ...
     public async Task<PhoneCallDetailDto> GetOrderDetailsAsync(string query, CancellationToken cancellationToken)
    {
        ...
        return completionResult.Data.Response == null ? null : JsonConvert.DeserializeObject<PhoneCallDetailDto>(completionResult.Data.Response);
    }

    private async Task<PhoneCallDetailDto> GetSimilarRestaurantByRecordAsync(PhoneCallRecord record, PhoneCallDetailDto foods, CancellationToken cancellationToken)
    {
        var result = new PhoneCallDetailDto { FoodDetails = new List<FoodDetailDto>() };
