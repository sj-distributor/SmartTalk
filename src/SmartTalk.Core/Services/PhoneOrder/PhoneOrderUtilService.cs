...
public class PhoneOrderUtilService : IPhoneOrderUtilService
{
    ...
    private async Task<PhoneOrderDetailDto> PerformQueryAsync(string query, OpenAiModel model, CancellationToken cancellationToken)
    {
            ...
            Messages = new List<CompletionsRequestMessageDto>
            {
                new()
                {
                    ...
                    Content = new CompletionsStringContent(
                        "你是一款高度理解语言的智能助手，根据所有对话提取Client的food_details和Client的user_phone_number" +
                        ...
                        "返回；规则：{\"user_phone_number\":\"电话号码\",\"food_details\": [{\"food_name\": \"菜品名字\",\"count\":减少的数量（负数）, \"remark\":null}]}}\n " +
                        ...
                        "output:{\"user_phone_number\": \"310-443-65070\"\"food_details\": [{\"food_name\":\"蒙古牛\",\"count\":1, \"remark\":null},{\"food_name\":\"蛋花湯\",\"count\":3, \"remark\":},{\"food_name\":\"椒鹽排骨\",\"count\":1, \"remark\":null},{\"food_name\":\"魚香肉絲\",\"count\":1, \"remark\":null},{\"food_name\":\"春卷\",\"count\":1, \"remark\":null},{\"food_name\":\"法式柠檬柳粒\",\"count\":1, \"remark\":null}]}\n " +
        ...
        return string.IsNullOrWhiteSpace(completionResult.Data.Response) ? null : JsonConvert.DeserializeObject<PhoneOrderDetailDto>(completionResult.Data.Response);
    }
