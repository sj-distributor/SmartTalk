...
public partial interface IAiSpeechAssistantService : IScopedDependency
{
    ...
    Task RepeatSalesOrderAsync(WebSocket twilioWebSocket, BinaryData audioData, CancellationToken cancellationToken);
}
...
public partial class AiSpeechAssistantService : IAiSpeechAssistantService
{
    ...
    private async Task ProcessRepeatOrderAsync(WebSocket twilioWebSocket, JsonElement jsonDocument, CancellationToken cancellationToken)
    {
        ...
        _backgroundJobClient.Enqueue<IAiSpeechAssistantService>(x => x.RepeatSalesOrderAsync(twilioWebSocket, audioData, CancellationToken.None));
    ...
    public async Task RepeatSalesOrderAsync(WebSocket twilioWebSocket, BinaryData audioData, CancellationToken cancellationToken)
    {
