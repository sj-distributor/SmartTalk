...
public partial class AiSpeechAssistantService : IAiSpeechAssistantService
{
    ...
    public async Task<AiSpeechAssistantConnectCloseEvent> ConnectAiSpeechAssistantAsync(ConnectAiSpeechAssistantCommand command, CancellationToken cancellationToken)
    {
        ...
        var (assistant, knowledge, prompt) = await BuildingAiSpeechAssistantKnowledgeBaseAsync(command.From, command.To, command.AssistantId, command.GreetingContent, cancellationToken).ConfigureAwait(false);
    ...
    private async Task<(Domain.AISpeechAssistant.AiSpeechAssistant assistant, AiSpeechAssistantKnowledge knowledge, string finalPrompt)> BuildingAiSpeechAssistantKnowledgeBaseAsync(string from, string to, int? assistantId, string greetingContent, CancellationToken cancellationToken)
    {
        ...
        knowledge.Greetings = string.IsNullOrEmpty(knowledge.Greetings) ? greetingContent : knowledge.Greetings;
