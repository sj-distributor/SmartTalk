...
public interface IRestaurantDataProvider : IScopedDependency
{
    ...
    Task<List<RestaurantMenuItem>> GetRestaurantMenuItemsAsync(int? restaurantId = null, int? pageIndex = null, int? pageSize = null, string keyword = null, CancellationToken cancellationToken = default);
...
public class RestaurantDataProvider : IRestaurantDataProvider
{
    ...
    public async Task<List<RestaurantMenuItem>> GetRestaurantMenuItemsAsync(int? restaurantId = null, int? pageIndex = null, int? pageSize = null, string keyword = null, CancellationToken cancellationToken = default)
    {
