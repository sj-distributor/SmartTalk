...
public interface IAutoTestDataImportHandler : IScopedDependency
{
    ...
    Task ImportAsync(Dictionary<string, object> import, int dataSetId, int assistantId, int agentId, CancellationToken cancellationToken = default); 
}
...
public class ExcelDataImportHandler : IAutoTestDataImportHandler
{
    ...
    public async Task ImportAsync(Dictionary<string, object> import, int dataSetId, int assistantId, int agentId, CancellationToken cancellationToken)
    {
