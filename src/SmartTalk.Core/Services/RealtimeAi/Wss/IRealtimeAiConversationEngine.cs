...
public interface IRealtimeAiConversationEngine : IAsyncDisposable, IScopedDependency
{
    ...
    event Func<RealtimeAiWssTranscriptionData, Task> TranscriptionReadyAsync;
    ...
    Task StartSessionAsync(Domain.AISpeechAssistant.AiSpeechAssistant assistantProfile, string initialUserPrompt, CancellationToken cancellationToken);
    /// <summary>
    /// 发送音频数据块给 AI。
