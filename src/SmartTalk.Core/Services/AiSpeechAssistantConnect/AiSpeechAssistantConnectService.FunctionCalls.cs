...
public partial class AiSpeechAssistantConnectService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return functionCallData.FunctionName switch
        {
            ...
            OpenAiToolConstants.QueryCustomerItemsByStoreName => await ProcessQueryCustomerItemsByStoreNameAsync(functionCallData, actions, cancellationToken).ConfigureAwait(false),
